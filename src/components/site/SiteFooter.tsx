		...
		<footer className="border-t border-stone-900/8 bg-[#faf7f3] text-stone-900">
			<div className="mx-auto grid w-full max-w-screen-2xl gap-14 px-6 py-20 md:grid-cols-2 md:gap-x-12 md:px-12 md:py-24 xl:grid-cols-[minmax(0,1.4fr)_minmax(260px,1.15fr)_180px_180px] xl:gap-x-16">
				<div className="grid content-start gap-5">
					...
					<p className="max-w-md text-[1.02rem] leading-normal text-stone-600">{description}</p>
				</div>

				<div className="grid content-start gap-12">
					<div className="grid gap-4">
						<p className="text-[0.62rem] font-semibold uppercase tracking-[0.3em] text-stone-600">{dictionary.footer.addressLabel}</p>
					...
					<div className="grid gap-4">
						<p className="text-[0.62rem] font-semibold uppercase tracking-[0.3em] text-stone-600">{dictionary.footer.inquiriesLabel}</p>
				...
				<div className="grid content-start gap-4">
					<p className="text-[0.62rem] font-semibold uppercase tracking-[0.3em] text-stone-600">{dictionary.footer.siteLabel}</p>
				...
				<div className="grid content-start gap-4">
					<p className="text-[0.62rem] font-semibold uppercase tracking-[0.3em] text-stone-600">{dictionary.footer.connectLabel}</p>
					<ul className="grid gap-4 text-sm font-semibold uppercase tracking-wider text-stone-700">
			...
			<div className="mx-auto flex w-full max-w-screen-2xl flex-col gap-4 border-t border-stone-900/8 px-6 py-8 text-[0.62rem] uppercase tracking-[0.24em] text-stone-600 md:flex-row md:items-center md:justify-between md:px-12">
