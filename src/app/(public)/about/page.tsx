			...
			<section className="grid gap-8 md:grid-cols-[minmax(0,1.1fr)_minmax(280px,0.7fr)] md:items-start">
				<div className="relative overflow-hidden border border-stone-900/8 bg-[linear-gradient(135deg,#f4f0ec_0%,#faf6f3_46%,#efebe7_100%)] px-7 py-10 sm:px-10 sm:py-12">
					...
					<div className="relative z-10 grid gap-4">
						<p className="text-[0.62rem] font-semibold uppercase tracking-[0.32em] text-[#715a3e]">Our Story & Philosophy</p>
				...
				<aside className="grid gap-5 bg-[#f6f1ec] p-8 sm:p-10">
					<p className="text-[0.62rem] font-semibold uppercase tracking-[0.32em] text-stone-400">Working Principle</p>
					<p className="text-3xl italic leading-none tracking-[-0.05em] text-stone-950 [font-family:var(--font-newsreader)]">
						One idea.
						<br />
						One line.
					</p>
					<p className="text-sm leading-7 text-stone-600">선언은 짧고, 실행은 집요하게. 브랜드와 스타일리스트가 필요로 하는 것은 과장된 수치가 아니라 반복해서 체감되는 결과입니다.</p>
					<div className="border-t border-stone-900/8 pt-5 text-[0.7rem] font-semibold uppercase tracking-[0.28em] text-stone-500">Momentum over vanity metrics</div>
				</aside>
			</section>
