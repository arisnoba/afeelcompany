...
export default async function HomePage() {
	...
	return (
		<>
			<section className="relative ml-[calc(50%-50vw)] w-screen overflow-hidden border-y border-stone-900/8 bg-[linear-gradient(135deg,#f4f0ec_0%,#f9f6f3_48%,#f2efeb_100%)] py-16 sm:py-20 lg:py-24">
						...
						{featuredItems.map(item => (
							<article key={item.id} className="group relative aspect-square overflow-hidden bg-stone-200">
								...
								<div className="absolute inset-x-0 bottom-0 grid gap-2 px-5 py-5 text-white sm:px-6">
									<p className="text-[0.62rem] font-semibold uppercase tracking-[0.28em] text-white/72">{item.category}</p>
